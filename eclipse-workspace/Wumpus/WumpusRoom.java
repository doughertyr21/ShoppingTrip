...
public class WumpusRoom {
		...
		void printInfo() {
			if (WumpusGame.hunger == 5) {
				System.out.println("You hear your stomach growling and your body getting weaker.");
			}
			if (WumpusGame.hunger == 0) {
				System.out.println("You fall to the ground from exhaustion.");
			...
			System.out.println(" Hunger: " + WumpusGame.hunger);
			System.out.println();
			for (int i = 1; i <= WumpusMap.N_DIRECTIONS; i++) {
				WumpusRoom room = roomInDirection(i);
